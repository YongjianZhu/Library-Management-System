...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { book_id: @wishlist.book_id, student_id: @wishlist.student_id } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { book_id: @wishlist.book_id, student_id: @wishlist.student_id } }
